(function(){
		var snstitle = $("#J_PostArtical").text();
	var snscontent = $("#J_Forumtitle").text();
	
	$.guang.editor = $.guang.Editor({
		formId:"J_PostCmtArea",
		btnFontSize:{
			visible:false
		}
	});
		$.guang.editor.mediaImgList = GUANGER.mediaImgList;
		$.guang.editor.mediaVideoList = GUANGER.mediaVideoList;
		
	$(".share a").click(function(){
		var title=jQuery.guang.editor.decodeContent4Sns(snstitle+snscontent),
