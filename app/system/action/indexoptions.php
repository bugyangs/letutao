...
switch($ts){
	...
	case "do_catename":
		...
		$db->query("update ".dbprefix."goods_cate set `cate_name`='$cate_name' where cate_id='$cate_id'");
		echo 1;
		break;
	case "add_subcate":
	...
	case "add_cate":
		...
		$cate_id = 1;
		$db->query("insert into ".dbprefix."goods_cate (`parent_id`,`cate_name`) values ('$cate_id','请修改')");
