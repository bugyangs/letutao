...
-- 数据库: `letutao_v2.4`
--
DROP TABLE IF EXISTS `le_area`,`le_attach`,`le_daren`,`le_diskyun_options`,`le_feed`,`le_goods_cate`,`le_goods_category_tags`,`le_goods_subcate`,`le_goods_tags`,`le_group`,`le_group_cates`,`le_group_cates_index`,`le_group_links`,`le_group_options`,`le_group_topics`,`le_group_topics_collects`,`le_group_topics_comments`,`le_group_topics_type`,`le_group_users`,`le_home_info`,`le_image_file`,`le_indexslide`,`le_mail_options`,`le_message`,`le_photo`,`le_photo_album`,`le_system_options`,`le_photo_comment`,`le_photo_options`,`le_search_key`,`le_share_goods`,`le_share_goods_comments`,`le_share_goods_like`,`le_share_theme_like`,`le_tag`,`le_tag_article_index`,`le_tag_default_goods`,`le_tag_group_index`,`le_tag_share_goods`,`le_tag_topic_index`,`le_tag_user_index`,`le_theme`,`le_theme_cate`,`le_tuan`,`le_tuan_cate`,`le_user`,`le_user_follow`,`le_user_info`,`le_user_invites`,`le_user_options`,`le_user_role`,`le_user_scores`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4603 ;
...
(4030, '殁EUR⑩EUR氱┖', '', '殁EUR⑩EUR氱┖', 100, 0, 0),
(4031, '鑽鈥扮尖EUR', '', '鑽鈥扮尖EUR', 100, 0, 0),
(4032, '瑁歌鈥安', '', '瑁歌鈥安', 100, 0, 0),
(4033, '娉㈣タ绫充号', '', '娉㈣タ绫充号', 100, 0, 0),
(4034, '浼鈥橀鈥敳', '', '浼鈥橀鈥敳', 100, 0, 0),
(4035, '娓鈥︽鈥摪', '', '娓鈥︽鈥摪', 100, 0, 0),
(4036, '玮EUR澃邂EUR涵', '', '玮EUR澃邂EUR涵', 100, 0, 0),
(4037, '玮劉炬惌', '', '玮劉炬惌', 100, 0, 0),
(4038, '驸EUR敟绯', '', '驸EUR敟绯', 100, 0, 0),
(4039, '纰沤枧牨', '', '纰沤枧牨', 100, 0, 0),
(4040, '邂EURΜ涓', '', '邂EURΜ涓', 100, 0, 0),
(4041, '桠EUR⒕涓', '', '桠EUR⒕涓', 100, 0, 0),
(4042, '驸EUR辜媾渐', '', '驸EUR辜媾渐', 100, 0, 0),
(4043, '娆х九', '', '娆х九', 100, 0, 0),
(4265, '昊天', '', '昊天', 100, 0, 1),
(4045, '绯鈥撴啪艙桠EUR安', '', '绯鈥撴啪艙桠EUR安', 100, 0, 0),
(4046, '殁EUR邯绾', '', '殁EUR邯绾', 100, 0, 0),
...
CREATE TABLE IF NOT EXISTS `le_image_file` (
  ...
  PRIMARY KEY  (`imageid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='图片附件表' AUTO_INCREMENT=6 ;
...
(2, '我的午后时光', '静谧的角落，明媚的阳光\r\n一杯热气腾腾的咖啡 \r\n 午后的时光总会镀上慵懒的味道\r\n  放慢脚步，享受这一切', 'http://www.gope.cn/', 'cache/bigpic/20130814/1376473705.jpg', 0, 1377354337),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='分享回复/评论' AUTO_INCREMENT=19 ;
...
CREATE TABLE IF NOT EXISTS `le_system_options` (
  ...
  PRIMARY KEY  (`optionid`),
  UNIQUE KEY `optionname` (`optionname`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统管理配置' AUTO_INCREMENT=30 ;
...
CREATE TABLE IF NOT EXISTS `le_theme_cate` (
  ...
  PRIMARY KEY  (`cateid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='主题分类' AUTO_INCREMENT=1 ;
