...
class SaeTClientV2
{
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/statuses/faxian_timeline statuses/faxian_timeline}
	 * 
	 * @access public
	 ...
	 * @return array
	 */
	function faxian_timeline( $page = 1, $count = 50, $since_id = 0, $max_id = 0, $base_app = 0, $feature = 0 )
	{
		$params = array();
		if ($since_id) {
		...
		return $this->oauth->get('statuses/faxian_timeline', $params);
	}

	/**
	 * 获取当前登录用户及其所关注用户的最新微博消息。
	 *
	 * 获取当前登录用户及其所关注用户的最新微博消息。和用户登录 http://weibo.com 后在“我的首页”中看到的内容相同。同faxian_timeline()
	...
	{
		return $this->faxian_timeline( $since_id, $max_id, $count, $page, $base_app, $feature);
	}
